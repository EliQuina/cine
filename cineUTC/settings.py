...
SECRET_KEY = 'django-insecure-2ugp$r(2l9@5^0v%c&e^u-586oup($*3agj#)e+lmfzmr5scb+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

#ALLOWED_HOSTS = []
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'cineutc-jhik.onrender.com').split(',')
...
#Configuracion de la carpeta para subir archivos dinamicas
MEDIA_URL='/media/'
